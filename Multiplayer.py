...
def main(order, host = None):
  ...
  while not end:
    ...
    if object_start_shift.rect.top <= start_up_shift and current_level.world_shift < -current_level.top_border:
    ...
    if player.rect.bottom >= start_down_shift and current_level.bottom_border + current_level.world_shift  > screen_y:
